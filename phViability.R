...
# ANALYSIS AND PLOT FOR VIABILITY AND PH
# MIT LICENSE
...
iteration1
# convert negatives to 0, this is likely an error due to rayleigh scatter

iteration1[["viability.percent"]][iteration1[["viability.percent"]] < 0 ] <- 0
iteration2[["viability.percent"]][iteration2[["viability.percent"]] < 0 ] <- 0
iteration3[["viability.percent"]][iteration3[["viability.percent"]] < 0 ] <- 0
...
iteration1.1hr.ph7.mean <- mean(iteration1.1hr.ph7$viability.percent)
iteration1.1hr.ph7b.mean <- mean(iteration1.1hr.ph7b$viability.percent)
iteration1.1hr.ph6.mean <- mean(iteration1.1hr.ph6$viability.percent)
iteration1.1hr.ph5.mean <- mean(iteration1.1hr.ph5$viability.percent)
iteration1.1hr.ph3.mean <- mean(iteration1.1hr.ph3$viability.percent)

iteration2.1hr.ph7.mean <- mean(iteration2.1hr.ph7$viability.percent)
iteration2.1hr.ph7b.mean <- mean(iteration2.1hr.ph7b$viability.percent)
iteration2.1hr.ph6.mean <- mean(iteration2.1hr.ph6$viability.percent)
iteration2.1hr.ph5.mean <- mean(iteration2.1hr.ph5$viability.percent)
iteration2.1hr.ph3.mean <- mean(iteration2.1hr.ph3$viability.percent)

iteration3.1hr.ph7.mean <- mean(iteration3.1hr.ph7$viability.percent)
iteration3.1hr.ph7b.mean <- mean(iteration3.1hr.ph7b$viability.percent)
iteration3.1hr.ph6.mean <- mean(iteration3.1hr.ph6$viability.percent)
iteration3.1hr.ph5.mean <- mean(iteration3.1hr.ph5$viability.percent)
iteration3.1hr.ph3.mean <- mean(iteration3.1hr.ph3$viability.percent)
...
iteration1.4hr.ph7.mean <- mean(iteration1.4hr.ph7$viability.percent)
iteration1.4hr.ph7b.mean <- mean(iteration1.4hr.ph7b$viability.percent)
iteration1.4hr.ph6.mean <- mean(iteration1.4hr.ph6$viability.percent)
iteration1.4hr.ph5.mean <- mean(iteration1.4hr.ph5$viability.percent)
iteration1.4hr.ph3.mean <- mean(iteration1.4hr.ph3$viability.percent)

iteration2.4hr.ph7.mean <- mean(iteration2.4hr.ph7$viability.percent)
iteration2.4hr.ph7b.mean <- mean(iteration2.4hr.ph7b$viability.percent)
iteration2.4hr.ph6.mean <- mean(iteration2.4hr.ph6$viability.percent)
iteration2.4hr.ph5.mean <- mean(iteration2.4hr.ph5$viability.percent)
iteration2.4hr.ph3.mean <- mean(iteration2.4hr.ph3$viability.percent)

iteration3.4hr.ph7.mean <- mean(iteration3.4hr.ph7$viability.percent)
iteration3.4hr.ph7b.mean <- mean(iteration3.4hr.ph7b$viability.percent)
iteration3.4hr.ph6.mean <- mean(iteration3.4hr.ph6$viability.percent)
iteration3.4hr.ph5.mean <- mean(iteration3.4hr.ph5$viability.percent)
iteration3.4hr.ph3.mean <- mean(iteration3.4hr.ph3$viability.percent)
...
iteration1.12hr.ph7.mean <- mean(iteration1.12hr.ph7$viability.percent)
iteration1.12hr.ph7b.mean <- mean(iteration1.12hr.ph7b$viability.percent)
iteration1.12hr.ph6.mean <- mean(iteration1.12hr.ph6$viability.percent)
iteration1.12hr.ph5.mean <- mean(iteration1.12hr.ph5$viability.percent)
iteration1.12hr.ph3.mean <- mean(iteration1.12hr.ph3$viability.percent)

iteration2.12hr.ph7.mean <- mean(iteration2.12hr.ph7$viability.percent)
iteration2.12hr.ph7b.mean <- mean(iteration2.12hr.ph7b$viability.percent)
iteration2.12hr.ph6.mean <- mean(iteration2.12hr.ph6$viability.percent)
iteration2.12hr.ph5.mean <- mean(iteration2.12hr.ph5$viability.percent)
iteration2.12hr.ph3.mean <- mean(iteration2.12hr.ph3$viability.percent)

iteration3.12hr.ph7.mean <- mean(iteration3.12hr.ph7$viability.percent)
iteration3.12hr.ph7b.mean <- mean(iteration3.12hr.ph7b$viability.percent)
iteration3.12hr.ph6.mean <- mean(iteration3.12hr.ph6$viability.percent)
iteration3.12hr.ph5.mean <- mean(iteration3.12hr.ph5$viability.percent)
iteration3.12hr.ph3.mean <- mean(iteration3.12hr.ph3$viability.percent)
...
iteration1.24hr.ph7.mean <- mean(iteration1.24hr.ph7$viability.percent)
iteration1.24hr.ph7b.mean <- mean(iteration1.24hr.ph7b$viability.percent)
iteration1.24hr.ph6.mean <- mean(iteration1.24hr.ph6$viability.percent)
iteration1.24hr.ph5.mean <- mean(iteration1.24hr.ph5$viability.percent)
iteration1.24hr.ph3.mean <- mean(iteration1.24hr.ph3$viability.percent)

iteration2.24hr.ph7.mean <- mean(iteration2.24hr.ph7$viability.percent)
iteration2.24hr.ph7b.mean <- mean(iteration2.24hr.ph7b$viability.percent)
iteration2.24hr.ph6.mean <- mean(iteration2.24hr.ph6$viability.percent)
iteration2.24hr.ph5.mean <- mean(iteration2.24hr.ph5$viability.percent)
iteration2.24hr.ph3.mean <- mean(iteration2.24hr.ph3$viability.percent)

iteration3.24hr.ph7.mean <- mean(iteration3.24hr.ph7$viability.percent)
iteration3.24hr.ph7b.mean <- mean(iteration3.24hr.ph7b$viability.percent)
iteration3.24hr.ph6.mean <- mean(iteration3.24hr.ph6$viability.percent)
iteration3.24hr.ph5.mean <- mean(iteration3.24hr.ph5$viability.percent)
iteration3.24hr.ph3.mean <- mean(iteration3.24hr.ph3$viability.percent)
...
iteration1.72hr.ph7.mean <- mean(iteration1.72hr.ph7$viability.percent)
iteration1.72hr.ph7b.mean <- mean(iteration1.72hr.ph7b$viability.percent)
iteration1.72hr.ph6.mean <- mean(iteration1.72hr.ph6$viability.percent)
iteration1.72hr.ph5.mean <- mean(iteration1.72hr.ph5$viability.percent)
iteration1.72hr.ph3.mean <- mean(iteration1.72hr.ph3$viability.percent)

iteration2.72hr.ph7.mean <- mean(iteration2.72hr.ph7$viability.percent)
iteration2.72hr.ph7b.mean <- mean(iteration2.72hr.ph7b$viability.percent)
iteration2.72hr.ph6.mean <- mean(iteration2.72hr.ph6$viability.percent)
iteration2.72hr.ph5.mean <- mean(iteration2.72hr.ph5$viability.percent)
iteration2.72hr.ph3.mean <- mean(iteration2.72hr.ph3$viability.percent)

iteration3.72hr.ph7.mean <- mean(iteration3.72hr.ph7$viability.percent)
iteration3.72hr.ph7b.mean <- mean(iteration3.72hr.ph7b$viability.percent)
iteration3.72hr.ph6.mean <- mean(iteration3.72hr.ph6$viability.percent)
iteration3.72hr.ph5.mean <- mean(iteration3.72hr.ph5$viability.percent)
iteration3.72hr.ph3.mean <- mean(iteration3.72hr.ph3$viability.percent)
